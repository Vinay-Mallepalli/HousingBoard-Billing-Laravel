<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
            <a class="navbar-brand brand-logo" href="#">Vinay's Housing</a>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end flex-grow-1">
        ...
        <h3 class="navbar-heading navbar-heading-large">Co-Operative Housing and Service Society</h3>
        <!-- Heading for smaller screens -->
        <h3 class="navbar-heading navbar-heading-small">Vinay's Housing</h3>
